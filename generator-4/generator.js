...
const TRAITS = {
  ...
  bodyColor: [
    ...
    { id: 'petrol',    hex: '#1F6F8B', weight: 6, rarity: 'common' },
...
const ONE_OF_ONE_WEIGHTS = {
  ...
  headColor: [{ id: 'matching', weight: 26 }, { id: 'gold', weight: 7 }, { id: 'chrome', weight: 6 }, { id: 'sunset', weight: 5 }, { id: 'aurora', weight: 5 }, { id: 'obsidian', weight: 5 }, { id: 'rose_gold', weight: 5 }, { id: 'purple', weight: 5 }, { id: 'petrol', weight: 4 }, { id: 'charcoal', weight: 4 }, { id: 'butter', weight: 4 }, { id: 'sky', weight: 4 }, { id: 'tomato', weight: 4 }, { id: 'mint', weight: 4 }, { id: 'bubblegum', weight: 4 }, { id: 'navy', weight: 4 }],
  legColor: [{ id: 'matching', weight: 34 }, { id: 'gold', weight: 8 }, { id: 'chrome', weight: 8 }, { id: 'charcoal', weight: 6 }, { id: 'petrol', weight: 6 }, { id: 'tomato', weight: 5 }, { id: 'sky', weight: 5 }, { id: 'butter', weight: 5 }, { id: 'navy', weight: 5 }, { id: 'magenta', weight: 5 }],
  handColor: [{ id: 'matching', weight: 34 }, { id: 'gold', weight: 8 }, { id: 'chrome', weight: 8 }, { id: 'charcoal', weight: 6 }, { id: 'petrol', weight: 6 }, { id: 'cherry', weight: 5 }, { id: 'lime', weight: 5 }, { id: 'tangerine', weight: 5 }, { id: 'cobalt', weight: 5 }, { id: 'bubblegum', weight: 5 }],
