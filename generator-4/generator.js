...
const TRAITS = {
  ...
  bodyColor: [
    ...
    { id: 'tomato',    hex: '#FF6F59', weight: 7, rarity: 'common' },
    { id: 'sky',       hex: '#79C3FF', weight: 7, rarity: 'common' },
    { id: 'butter',    hex: '#FFD45C', weight: 7, rarity: 'common' },
    { id: 'mint',      hex: '#7FD8BE', weight: 7, rarity: 'common' },
    { id: 'coral',     hex: '#FF8A7A', weight: 7, rarity: 'common' },
    { id: 'teal',      hex: '#33B5AC', weight: 7, rarity: 'common' },
    { id: 'cobalt',    hex: '#4F7CFF', weight: 7, rarity: 'common' },
    { id: 'grape',     hex: '#8E6CEF', weight: 7, rarity: 'common' },
    { id: 'lime',      hex: '#B5E655', weight: 7, rarity: 'common' },
    { id: 'peach',     hex: '#FFB38A', weight: 7, rarity: 'common' },
    { id: 'seafoam',   hex: '#9EE6CF', weight: 7, rarity: 'common' },
    { id: 'sand',      hex: '#E8C98F', weight: 7, rarity: 'common' },
    { id: 'bubblegum', hex: '#FF9ECF', weight: 4, rarity: 'uncommon' },
    { id: 'lilac',     hex: '#B69CFF', weight: 4, rarity: 'uncommon' },
    { id: 'tangerine', hex: '#FF9F45', weight: 4, rarity: 'uncommon' },
    { id: 'steel',     hex: '#A3AEBB', weight: 4, rarity: 'uncommon' },
    { id: 'cherry',    hex: '#E8434F', weight: 4, rarity: 'uncommon' },
    { id: 'forest',    hex: '#3E9C6B', weight: 4, rarity: 'uncommon' },
    { id: 'navy',      hex: '#3A5A96', weight: 4, rarity: 'uncommon' },
    { id: 'plum',      hex: '#A0529B', weight: 4, rarity: 'uncommon' },
    { id: 'mustard',   hex: '#E0A526', weight: 4, rarity: 'uncommon' },
...
function renderFromTraits(picks, index, seed) {
  ...
  for (const h of hands) {
    ...
    const hs = (h.rot || armStyle === 'on_floor') ? 1 : 1.2;
...
const ONE_OF_ONE_WEIGHTS = {
  ...
  arms: [{ id: 'broken', weight: 24 }, { id: 'telescopic', weight: 22 }, { id: 'on_floor', weight: 20 }, { id: 'spring', weight: 16 }, { id: 'jointed', weight: 14 }, { id: 'tube', weight: 4 }],
